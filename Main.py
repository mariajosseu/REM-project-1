...
from data.data import unit_cost_G, technical_data_G, technical_data_W
...
# balance constraint: sum of all generation + wind == demand
constraints_coeff["balance"] = {v: 1 for v in VARIABLES}
